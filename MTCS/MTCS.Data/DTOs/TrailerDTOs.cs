...
namespace MTCS.Data.DTOs
{
    public class CreateTrailerDTO
    {
        ...
        [EnumDataType(typeof(ContainerSize), ErrorMessage = "Invalid container size")]
    ...
    public class TrailerBasicInfoResultDTO
    {
        public PagedList<TrailerBasicDTO>? Trailers { get; set; }
